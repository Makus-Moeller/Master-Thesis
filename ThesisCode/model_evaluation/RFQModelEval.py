...
from TabularRL.RFQAgent import RFQAgent
...
class RFQModelEval:
    ...
    def parse_results(self, results):
        ...
        row["MLSharpeRatioHitrate"] = eval_utils.MLSharpeRatioHitrate(results)

        row["DealerSharpeRatioHitrate"] = eval_utils.DealerSharpeRatioHitrate(results)
